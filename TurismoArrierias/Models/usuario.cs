...
namespace TurismoArrierias.Models
{
    public class usuario
    {
        ...
        public String tipo;//admin, comerciante, usuario estandar
    ...
    String preferencias;//gustos seleccionados por el usuario (el campo es llenado por la seleccion del usuario en la vista las preferencias estan separadas por coma)
